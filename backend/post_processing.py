...
Reddit_answers[
    'tagline'] = 'We are going to build an infrastructure that will allow consumers to order food from their cell phones (via a text-interface, rather than voice), drive to the restaurant and pick up their order'
Reddit_answers[
    'model'] = 'We will make money by charging a percentage commission on every order made through our service. Our business model is B2B, and our business clients will be restaurants.'
...
TheMuse_answers[
    'model'] = 'In addition to pay-to-post career opportunities, we offer smart content and soon to be launched professional development courses'
...
Makegameswithus_answers[
    'tagline'] = 'We will build a matchmaking website that allows engineers and artists to make mobile games together.'
...
revmodkeys = ['freemium', 'ads', 'pay per click', 'percentage commission', 'ppc', 'pay-to-post', 'cost per impression',
              'cpi', 'cpm', 'advertising', 'affiliate promotion paid membership sites product sales']
